...
export default function Scene() {
    const { isCalendarVisible } = useStore();

    return (
        <div className={`fixed inset-0 z-0 transition-all duration-700 ${!isCalendarVisible ? 'pointer-events-auto' : 'pointer-events-none'}`}>
            <Canvas dpr={[1, 1.5]}>
                <Suspense fallback={null}>
                    ...
                    <InteractiveDrawing enabled={!isCalendarVisible} />
